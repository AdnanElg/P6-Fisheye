class PhotographerSection2{constructor(photographerDataMediaById,photographerDataById){this._photographers=photographerDataMediaById;this._photographers2=photographerDataById}createPhotographFilterSection2(){const photograph_section2=document.createElement("div");photograph_section2.classList.add("sort-container");const photographerFilter=`
    ...
    `;photograph_section2.innerHTML=photographerFilter;setTimeout(()=>{for(let i=0;i<this._photographers.length;i++){const filter=new Filter(this._photographers[i],this._photographers);filter.openFilterInit();filter.closeFilterInit();filter.filterPopularité(this._photographers,this._photographers2);filter.filterDate(this._photographers,this._photographers2);filter.filterTitre(this._photographers,this._photographers2)}},50);return photograph_section2}}