class PhotographerSection4 {
  ...
  createPhotographTotalSection4() {
    ...
    const photographerTotal = `
          <span aria-label= "Nombre de likes : ${this.sommesLikes}" id='totalCountLikes-${this.sommesLikes}'>${this.sommesLikes} <i class="heart fas fa-heart"></i></span> 
    ...
    setTimeout(() => {
      const countLike = new Likes();
      countLike.totalCounterLike(this.sommesLikes);
    }, 50);
